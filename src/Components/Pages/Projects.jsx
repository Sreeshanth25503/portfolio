...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A modern, fully responsive personal portfolio website built with React and Tailwind CSS. Features custom hash-based routing, a scroll-spy navbar, individual project detail pages, and is deployed on Vercel with automatic CI/CD from GitHub.',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map(project => (
            <div
              key={project.id}
              id={project.id}
              className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-2xl transition-all hover:scale-[1.02] group flex flex-col"
            >
              {/* Clickable card header — navigates to detail page */}
              <Link
                to={project.route}
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map(tech => (
                      <span
                        key={tech}
                        className="px-3 py-1.5 bg-gradient-to-br from-gray-50 to-gray-100 text-gray-700 rounded-lg text-sm font-medium border border-gray-200"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              {/* Footer row — GitHub link + "View Details" CTA */}
              <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
                <a
                  ...
                  className="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors font-medium text-sm"
                >
                ...
                <Link
                  to={project.route}
                  className="inline-flex items-center text-gray-900 font-semibold text-sm hover:underline"
                >
                  View Details

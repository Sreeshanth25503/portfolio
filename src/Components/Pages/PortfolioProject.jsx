...
const PortfolioProject = () => {
  const project = {
    ...
    description: 'A modern, fully responsive personal portfolio website built with React and Tailwind CSS. Features smooth scroll-spy navigation, hash-based client-side routing, and detailed project showcase pages.',
    ...
    live: null, // TODO: update with your real Vercel URL once deployed
    features: [
      ...
      <div className="flex flex-wrap gap-4 mb-12">
        ...
        {project.live && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 border-2 border-gray-900 text-gray-900 rounded-md hover:bg-gray-900 hover:text-white transition-colors font-medium"
          >

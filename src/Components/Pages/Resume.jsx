...
const Resume = () => {
  // Updated resume link — Task 2
  const resumeUrl = 'https://drive.google.com/file/d/1k3Ur0txdOevmg6nv9qs4Fp3TlApv9Zhd/view?usp=sharing';
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4
                ...
                transition-all hover:scale-105 shadow-lg font-semibold text-lg"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4
                ...
                rounded-lg transition-all hover:scale-105 shadow-lg font-semibold text-lg"
            >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-bold text-gray-900 dark:text-white mb-3 text-xl">Education</h3>
              <p className="text-gray-600 dark:text-gray-400">Master of Computer Applications (MCA)</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-bold text-gray-900 dark:text-white mb-3 text-xl">Specialization</h3>
              <p className="text-gray-600 dark:text-gray-400">Python Development &amp; AI/ML</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif font-bold text-gray-900 dark:text-white mb-3 text-xl">Experience</h3>
              <p className="text-gray-600 dark:text-gray-400">Full-Stack &amp; AI Projects</p>
            </div>
          </div>
        </div>
      </div>
